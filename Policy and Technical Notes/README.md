# Policy and Technical Notes — Index

This folder contains all working notes, technical notes, and policy notes produced for the project *El Salvador's Political Economy of Fiscal Policy, 1953–1980*.

**Rule:** Every note produced in a working session is pushed here before the session ends. This index is updated accordingly.
...
|:-:|:------|:-----|:------------|
| P1 | Pleites Chapter 1 Working Note | Mar 2026 | Review of Chapters 1A/1B + fiscal deep-dive: Ezeta, gold standard, 1922 Empréstito, failed tax reforms, monetary modernization, nature of the MAE state. Word doc produced in session, needs to be reconstructed and filed. |
| P2 | Pleites Chapter 2 Working Note | Mar 2026 | Review of Chapters 2A/2B + fiscal deep-dive: MISI period 1949–1980, revenue transformation, military-elite compromise, agrarian reform failure. Word doc produced in session, needs to be reconstructed and filed. |
